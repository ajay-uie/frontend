...
export default function CartPage() {
  ...
  const handleQuantityChange = async (itemId: string, size: string, newQuantity: number) => {
  ...
  const handleApplyPromo = () => {
    ...
    if (discountPercent) {
      const discountAmount = discountPercent <= 100 ? (subtotal * discountPercent) / 100 : discountPercent
      setAppliedPromo({ code: promoCode.toUpperCase(), discount: Math.min(discountAmount, subtotal) })
      setPromoCode("")
                  ...
                  {appliedPromo ? (
                    ...
                    <div className="space-y-3">
                      ...
                      <div className="text-xs text-gray-500">
                        <p>Available codes: WELCOME10, FLAT200, SAVE15</p>
                      </div>
                    </div>
                  )}
                </CardContent>
