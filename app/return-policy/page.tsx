          ...
          <div className="prose prose-gray max-w-none">
            <div className="bg-red-50 border border-red-200 rounded-lg p-6 mb-8">
              ...
              <p className="text-red-700">
                ...
                <br />
                Due to the nature of our luxury fragrance products, we have a strict no-return policy except under
            ...
            <p className="text-gray-700">
              For return requests or questions about our policy:
              <br />
              Email: returns@fragransia.in
              <br />
              Phone: 18002094004
              <br />
